...
#' @returns Timeliness results for both indicators grouped by region, country, and month with median comparisons between current and previous year
#' @export
#' @examples
#' \dontrun{
#' # Default to analyze both shipment and detection timeliness
#' es_timeliness(es_data)
#'
#' # With custom end date
#' es_timeliness(es_data, end_date = as.Date("2024-06-20"))
#' }
