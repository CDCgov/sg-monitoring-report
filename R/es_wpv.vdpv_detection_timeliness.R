#' WPV/VDPV Detection Timeliness for ES Samples
#' @description Days between ES sample collection and final combined result for WPV/VDPV positive samples (Targets: 35 days full capacity, 46 days limited capacity, ≥80% target for both)
